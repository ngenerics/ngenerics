...
namespace NGenerics.Tests.DataStructures.General.SortedListTests
{
    ...
    public class Index
    {
        ...
        public void ExceptionInvalidIndexGet1()
        {
            ...
            int i;
            Assert.Throws<ArgumentOutOfRangeException>(() => i = sortedList[0]);
        }
        ...
        public void ExceptionInvalidIndexGet3()
        {
            ...
            int i;
            Assert.Throws<ArgumentOutOfRangeException>(() => i = sortedList[sortedList.Count]);
        }
        ...
        public void ExceptionInvalidIndexSet()
        {
            ...
            Assert.Throws<NotSupportedException>(() => sortedList[0] = 5);
        }
