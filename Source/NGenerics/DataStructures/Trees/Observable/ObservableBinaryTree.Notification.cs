...
{
    /// <summary>
    /// An observable version of the <see cref="BinaryTree{T}"/>.
    /// </summary>
    ...
    public partial class ObservableBinaryTree<T> : INotifyCollectionChanged, INotifyPropertyChanged
    {
        ...
        /// <inheritdoc />
        public ObservableBinaryTree(T data)
            : base(data, null, null)
        {
        ...
        /// <inheritdoc />
        public ObservableBinaryTree(T data, T left, T right)
            : base(data, new BinaryTree<T>(left), new BinaryTree<T>(right))
        {
            monitor = new SimpleMonitor();
        }
