...
namespace NGenerics.Patterns.Conversion
{
    ...
    public interface IConverter<TInput, TOutput>
    {
        ...
        /// <code source="..\..\Source\Examples\ExampleLibraryCSharp\Patterns\Conversion\ConverterExamples.vb" region="Convert" lang="vbnet" title="The following example shows how to use the Convert method."/>
        /// </example>
