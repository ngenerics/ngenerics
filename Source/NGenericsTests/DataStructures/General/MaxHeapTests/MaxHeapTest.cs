...
namespace NGenerics.Tests.DataStructures.General.MaxHeapTest
{
    ...
    [TestFixture]
    public class Accept : MaxHeapTest
    {
        [Test]
        public void Simple()
        {
    ...
    [TestFixture]
    public class GetEnumerator : MaxHeapTest
    {
        [Test]
    ...
    [TestFixture]
    public class Serializable : MaxHeapTest
    {
        [Test]
        public void Simple()
        {
